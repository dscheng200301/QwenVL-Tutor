...
DATASETS = [
    ...
    ("mathverse", "dataset/edu_math_verse.parquet", None),  # 全量 3.9K
    ("mathvista", "dataset/edu_math_vista.parquet", None),  # 全量 1K
    ...
    ("gaokao", "dataset/edu_gaokao.parquet", None),         # 高考真题 6K
    ("math23k", "dataset/edu_math23k.parquet", 20000),      # 中文小学数学 23K（取20K）
    ("ape210k", "dataset/edu_ape210k.parquet", 20000),      # 中文小学数学 210K（取20K）
    # === 补充：多模态理科 ===
    ("mmmu", "dataset/edu_mmmu.parquet", 5000),              # 30学科多模态大学图文题 11K（取5K）
    ("geoqa", "dataset/edu_geoqa.parquet", 10000),           # 中文几何选择题 73K（取10K）
    ("biology", "dataset/edu_biology.parquet", 5000),        # BioVQA 生物图文题 5K
]

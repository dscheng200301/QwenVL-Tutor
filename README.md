...
| | OCR-VQA | EN | 20,000 | ✅ | OCR 图文题（降权20-30%） | SFT⚠️ |
| **中文理科** | C-Eval | CN | 2,654 | ❌ | 中文理科14个学科 | SFT |
| | CMMLU | CN | 11,917 | ❌ | 中文67学科综合 | SFT |
| **语言理解** | RACE | CN/EN | 10,000 | ❌ | 中英文阅读理解 | SFT |
| **生物** | BioVQA | EN | 0 | ✅ | 生物图文题（待修复） | SFT |
| | **合计** | | **85,729** | | | |

> **待修复可下载**（4个，~20K）：MMMU、GeoQA+、Geometry3K、DVQA（代码已修复，需 HF_TOKEN）  
> **HF 已下架**（7个）：TabMWP、GAOKAO-Bench、Math23K、AI2D、TQA、VizWiz、CLEVR-Math  
> 详情参见 [DATA.md](DATA.md)

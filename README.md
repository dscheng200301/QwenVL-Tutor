...
| 数据集 | 条数 | SFT | DPO | GRPO | 评估 | 备注 |
|--------|------|:---:|:---:|:----:|------|------|
| ScienceQA | 6,218 | ✅ | ✅ | ✅ | test split(holdout) / val split(日常) | 全理科图文，带 lecture 解析 |
| MathVerse | 3,940 | ✅ | | | — | 数学 VLM 推理 |
| MathVista | 1,000 | ✅ | | | — | 数学视觉推理 |
| OCR-VQA | 20,000 | ✅⚠️ | | | — | ⚠️ 降权到 20-30% batch |
| C-Eval | 2,654 | ✅ | | | 5个保留学科 | 中文理科14个子集(训练用9个，评估用5个) |
| CMMLU | 11,917 | ✅ | | | — | 中文67学科综合 |
...
├── scripts/                       # 工具脚本
│   ├── convert_edu_data.py       # 数据集格式转换（支持13种格式）
